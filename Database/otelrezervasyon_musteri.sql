...
CREATE TABLE `musteri` (
  ...
  `musteri_yas` tinyint(3) DEFAULT NULL,
  `musteri_tc` int(11) DEFAULT NULL,
  `musteri_tel` int(11) DEFAULT NULL,
  `musteri_ucret` double(255,0) DEFAULT NULL,
  PRIMARY KEY (`musteri_id`,`oda_id`) USING BTREE,
  UNIQUE KEY `oda_id_UNIQUE` (`oda_id`),
  UNIQUE KEY `musteri_id_UNIQUE` (`musteri_id`),
  CONSTRAINT `musteri_oda` FOREIGN KEY (`oda_id`) REFERENCES `otel` (`oda_id`) ON DELETE CASCADE ON UPDATE CASCADE
